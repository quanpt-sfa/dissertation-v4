    ...
    frame = pd.DataFrame(
        {
            ...
            "reason_unknown": pd.Series([pd.NA, "OBSERVATION_OPPORTUNITY_UNKNOWN"], dtype="string"),
            ...
            "sanction_year": pd.Series([pd.NA, pd.NA], dtype="Int16"),
            "target_fiscal_year": pd.Series([pd.NA, pd.NA], dtype="Int16"),
            "decision_count": pd.Series([pd.NA, pd.NA], dtype="Int64"),
            "document_ids": pd.Series([pd.NA, pd.NA], dtype="string"),
            "decision_numbers": pd.Series([pd.NA, pd.NA], dtype="string"),
            "total_fine": pd.Series([float("nan"), float("nan")], dtype="float64"),
            "has_fine": pd.Series([pd.NA, pd.NA], dtype="boolean"),
            "has_suspension": pd.Series([pd.NA, pd.NA], dtype="boolean"),
            "has_warning": pd.Series([pd.NA, pd.NA], dtype="boolean"),
            "has_remedy": pd.Series([pd.NA, pd.NA], dtype="boolean"),
            "first_label_known_date": pd.Series([pd.NaT, pd.NaT], dtype="datetime64[ns]"),
            "last_label_known_date": pd.Series([pd.NaT, pd.NaT], dtype="datetime64[ns]"),
            "taxonomy_codes": pd.Series([pd.NA, pd.NA], dtype="string"),
            "taxonomy_reason_code": pd.Series([pd.NA, pd.NA], dtype="string"),
