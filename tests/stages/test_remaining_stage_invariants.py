...
def _columns() -> dict[str, str]:
    return {
        ...
        OBSERVATION_OPPORTUNITY: "observation_opportunity_key",
        VERIFICATION_STATUS: "verification_status_key",
        DETERMINATION_STATUS: "determination_status_key",
        RECORDING_STATUS: "recording_status_key",
        OBSERVED_SOURCE_LABEL: "observed_source_label_key",
        VERIFICATION_DATE: "verification_date_key",
        DETERMINATION_DATE: "determination_date_key",
        RECORDING_DATE: "recording_date_key",
        LAYER_OBSERVED_MASK: "layer_observed_mask_key",
        REASON_UNKNOWN: "reason_unknown_key",
