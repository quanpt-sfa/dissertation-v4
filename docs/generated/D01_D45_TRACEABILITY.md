...
| D04 | Kênh bằng chứng thực thi | Nguồn thực thi chính thức được xem là proxy bằng chứng dương quan sát có chọn lọc; không mặc định độ đặc hiệu cao. | T004 | raw_audit, l3_pilot_capability |
| D05 | Outcome chính | L1: BJ_i,t,h đã trưởng thành và follow-up đầy đủ. | T005 | l0_l1_inputs, evaluation_metrics |
| D06 | Miền hạn chế nhận dạng | Chỉ restriction đã đăng ký, có nguồn độc lập, đánh giá khả chuyển và phê duyệt mới được dùng để tạo identified set. | T006 | l3_pilot_capability, simulation_scenario_registry |
| D07 | Ngân sách rà soát | Top 5% tập rủi ro. | T007 | utility_scenarios |
| D08 | Learner roster | Elastic-net logistic, random forest, một boosting chính; nhánh PU theo kênh bằng chứng dương. | T008 | model_artifacts |
...
| D17 | Mô hình L3 | Fixed-π latent class, source-specific Se/Sp, channel random effect và MCMC; Se/Sp không được xem là đã nhận dạng nếu thiếu căn cứ độc lập. | T017 | l3_pilot_capability, hierarchical_pi_sensitivity |
...
| D28 | Tập dương PU | PU chỉ dùng tập dương từ kênh bằng chứng đã đăng ký; S=0 vẫn là unlabeled/observed endpoint zero, không phải latent negative. | T028 | model_artifacts |
...
| D40 | Cơ chế sinh dữ liệu | Sinh Y*, rồi tách O, V, D, R và S theo từng nguồn; đồng thời sinh phụ thuộc kênh, độ trễ và dịch chuyển. | T040 | simulation_scenario_registry |
| D41 | Không gian kịch bản | Prevalence, sai số nguồn, O/V/D/R, phụ thuộc, delay, shift, cỡ mẫu và signal structure. | T041 | simulation_scenario_registry |
| D42 | Phương pháp mô phỏng | L0–L3, logistic, boosting, observability/content/full và PU theo kênh bằng chứng dương; oracle chỉ làm chuẩn trên. | T042 | simulation_scenario_registry |
